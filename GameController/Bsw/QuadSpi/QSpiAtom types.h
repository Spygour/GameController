...
#ifndef QSPIATOMTYPES_H_
#define QSPIATOMTYPES_H_
...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
typedef void (*IfxGtm_Atom_SerialTimers_Update)(IfxGtm_Atom_PwmHl *driver,
                                                Ifx_TimerValue *tOn);
typedef struct 
{
  Ifx_Pwm_Mode mode; /**< \brief Pwm Mode */
  boolean inverted;  /**< \brief Inverted configuration for the selected mode */
  IfxGtm_Atom_SerialTimers_Update
      setMode; /**< \brief update call back function for the selected mode */
} IfxGtm_Atom_Serial;
