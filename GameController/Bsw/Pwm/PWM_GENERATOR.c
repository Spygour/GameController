...
static inline void initTomPwmConfig(uint16 period,uint16 dutyCycle,uint16 clock,IfxGtm_Tom_ToutMap* pin,Ifx_GTM *gtm, IfxSrc_Tos coreNum)
{
    ...
    tomPwmConfig.interrupt.isrProvider    = coreNum;
...
static inline void initAtomPwmConfig(uint16 period,uint16 dutyCycle,IfxGtm_Atom_ToutMap* pin,Ifx_GTM *gtm,  IfxSrc_Tos coreNum)
{
    ...
    atomPwmConfig.interrupt.isrProvider    = coreNum;
...
void TomPwm_Init(IfxGtm_Tom_Pwm_Driver* mytomdriver, uint16 period, uint16 dutyCycle, uint16 clock, IfxGtm_Tom_ToutMap* pin, IfxSrc_Tos coreNum)
{
  ...
  initTomPwmConfig(period,dutyCycle,clock,pin,&MODULE_GTM, coreNum);
...
void AtomPwm_Init(IfxGtm_Atom_Pwm_Driver* myatomdriver,uint16 period,uint16 dutyCycle,IfxGtm_Atom_ToutMap* pin,  IfxSrc_Tos coreNum)
{
  ...
  initAtomPwmConfig(period,dutyCycle,pin,&MODULE_GTM, coreNum);
