...
boolean IfxGtm_Atom_TimerSerial_init(IfxGtm_Atom_Timer *driver, const IfxGtm_Atom_Timer_Config *config, uint32 bitShift, boolean AruEnable)
{
  ...
  /* Initialize the timer part */
  IfxGtm_Atom_Ch_configureOutputSerial(driver->atom, driver->timerChannel, config->clock,
...
boolean IfxGtm_Atom_Timer_setBitShift(IfxGtm_Atom_Timer *driver, uint32 bitShift)
{
  return IfxGtm_Atom_Timer_setPeriod(driver, bitShift);
}
