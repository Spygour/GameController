...
/** \brief Sets the number of bits shifted in serial mode
 * \param driver ATOM Timer interface Handle
 * \param frequency bitShift
 * \return TRUE on success else FALSE
 */
IFX_EXTERN boolean IfxGtm_Atom_Timer_setBitShift(IfxGtm_Atom_Timer *driver, uint32 bitShift);
