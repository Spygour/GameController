...
/** \brief Configures the Mode to be SOMP
 * \param atom Pointer to the ATOM object
 * \param channel Channel index
...
/** \brief Configures the Mode to be SOMS
 * \param atom Pointer to the ATOM object
 * \param channel Channel index
 * \param clock Clock source
 * \param activeState Active State
 * \param aru connected or not with the Atom channel
 */
IFX_EXTERN void IfxGtm_Atom_Ch_configureOutputSerial(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Cmu_Clk clock, Ifx_ActiveState activeState, IfxGtm_Atom_AruInput aruConnected);
