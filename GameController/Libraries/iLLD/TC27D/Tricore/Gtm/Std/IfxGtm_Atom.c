...
void IfxGtm_Atom_Ch_configureOutputSerial(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_Cmu_Clk clock, Ifx_ActiveState activeState, IfxGtm_Atom_AruInput aruConnected)
{
  Ifx_GTM_ATOM_CH     *atomCh = IfxGtm_Atom_Ch_getChannelPointer(atom, channel);
  Ifx_GTM_ATOM_CH_CTRL ctrl;

  ctrl.U          = 0;
  ctrl.B.MODE     = IfxGtm_Atom_Mode_outputSerial;
  ctrl.B.ARU_EN   = aruConnected;
  ctrl.B.ACB      = 0;
  ctrl.B.OSM      = 0;
